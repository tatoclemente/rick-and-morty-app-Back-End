      ...
      <section className={Style.presentation}>
        <div className={Style.textContainer}>
          ...
          <p>
            ...
            nam vero cumque quam error, officiis qui, reprehenderit soluta unde
            corrupti minus recusandae voluptatum id deleniti sed enim animi quia
            et?
          </p>
        </div>
      ...
      <section className={Style.presentation}>
        <div className={Style.textContainer}>
          ...
          <p>
            ...
            deserunt modi praesentium in, vitae voluptatem facere esse sed eos
            delectus corporis a, ut ex, obcaecati libero ab dolore nobis beatae?
          </p>
        </div>
